    ...
    <div class="row">
      <div class="col-lg-3 mb-3">
        ...
        <ul class="list-unstyled small">
          <li class="mb-2">Llega en forma al VERANO, empeza a ENTRENAR YA. Encontra tu mejor VERSIÓN, empeza a sentirte BIEN. Gánale a la inflación CONGELA EL PRECIO DE TU PASE LIBRE.</li>
          </ul>
      </div>
